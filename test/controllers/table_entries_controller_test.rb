...
class TableEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table_entry" do
    assert_difference("TableEntry.count") do
      post table_entries_url, params: { table_entry: { row_number: @table_entry.row_number, value: @table_entry.value } }
    end
  ...
  test "should update table_entry" do
    patch table_entry_url(@table_entry), params: { table_entry: { row_number: @table_entry.row_number, value: @table_entry.value } }
